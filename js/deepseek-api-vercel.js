/**
 * DeepSeek API 接口 - Vercel版本
 * 用于处理与DeepSeek AI的通信，通过Vercel代理解决CORS问题
 * 版本: 3.0.0
 */
class DeepSeekAPI {
    /**
     ...
     * @param {string} proxyUrl - Vercel代理URL
     */
    constructor(apiKey, proxyUrl) {
        ...
        // Vercel代理URL
        this.proxyUrl = proxyUrl || 'https://deepseek-proxy-zeta.vercel.app/api/proxy'; // 已更新为实际部署URL
...
- 适度友好：保持专业的同时，语气友好亲切`;
    ...
    async sendMessage(message, onThinking, onResponse, onError) {
        ...
        try {
            ...
            console.log('正在发送请求到Vercel代理:', this.proxyUrl);
